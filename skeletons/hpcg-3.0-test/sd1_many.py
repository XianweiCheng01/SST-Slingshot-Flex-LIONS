...
_params["input_buf_size"] = "32B"
_params["output_buf_size"] = "32B"
...
_params["debug"] = debug
_params["num_ports"] = radix + 1 #the 1 for ctrl port
...
def getLink(leftName, rightName, num):
    ...
    #print("GetLink with name: " + name + "GetLink with num: %d", num)
...
def macroNode(nID):
    ...
    node.addParams({
      #"debug" : "sumi_collective",
      #"debug" : ["nic", "sumi_collective", "parallel", "sumi"],
      #"debug" : ["nic"],
      # 'id' : '3',
      'name' : 'simple',
      ...
      #'app1.exe' : '../pic/runpic',
      #'app1.argv' : '10 30 10 10 10 2 2 2',

      #'app1.exe' : '../misses/runmiss',
      #'app1.argv' : '10 30 10 10 10 2 2 2',

      #'app1.argv' : '32 32 32',
      # 'app1.exe' : './hello_world',
      # 'app1.argv' : '--nx=32 --ny=32 --nz=32',
      #'app1.argv' : '16 16',
      # 'app1.argv' : '16 64',
      # 'app1.argv' : '26 512',
      # 'app1.argv' : '20 16',
      ...
      #'app1.coordinate_file' : './coord1.txt',
      #'app1.exe' : './runhpcg-3.0',
      ...
      'nic.output_buf_size' : '32B',
      # 'nic.id' : '3',
      'nic.topology' : 'merlin.torus',
      'nic.port_name' : 'input1',
      'nic.update_freq' : '2KHz',

      'topology.auto' : 'true',
      'topology.geometry' : '[2,2,2]',
      #'topology.update_freq' : '2MHz',
      #'topology.geometry' : '[2,1,1]',
      ...
      #'interconnect.topology.geometry' : '[2,1,1]',
...
for i in range(num_routers):
    ...
    rtr.addParam("id", i)
    rtr.addParam("extra_port", 1)
    rtr.addParam("debug", 1)
    ...
    for n in  range(_params["local_ports"]):
        ...
        if ep:
            ...
            nicLink.connect((ep, "input1", "1000ps"), (rtr, "port%d"%port, _params["link_lat"]))
        port = port + 1
        if (n == int(_params["local_ports"]) - 1):
          ctlLink = sst.Link("ctl_link.%d"%(i))
          ctlLink.connect((ep, "ctl_port", "1ps"),(rtr, "port%d"%port, "1ps"))
