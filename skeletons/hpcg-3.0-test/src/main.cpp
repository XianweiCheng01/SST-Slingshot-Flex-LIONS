...
int main(int argc, char * argv[]) {
  ...
  if (rank==0) std::cout << "Total time 0: " << mytimer() << endl;
  ...
  if (rank==0) std::cout << "Total time 1: " << mytimer() << endl;
  ...
  if (rank==0) std::cout << "Total time 2: " << mytimer() << endl;
  ...
  if (rank==0) std::cout << "Total time 3: " << mytimer() << endl;
...
#endif
  if (rank==0) std::cout << "Total time 4: " << mytimer() << endl;
  ...
  if (rank==0) std::cout << "Total time 5: " << mytimer() << endl;
  ...
  if (rank==0) std::cout << "Total time 6: " << mytimer() << endl;
  ...
  if (rank==0) std::cout << "Total time 7: " << mytimer() << endl;
  TestSymmetryData testsymmetry_data;
  TestSymmetry(A, b, xexact, testsymmetry_data);

  if (rank==0) std::cout << "Total time 8: " << mytimer() << endl;
#ifdef HPCG_DEBUG
  ...
  if (rank==0) std::cout << "Total time 9: " << mytimer() << endl;
#ifndef HPCG_NO_MPI
// Get the absolute worst time across all MPI ranks (time in CG can be different)
  ...
  if (rank==0) std::cout << "Total time 10: " << mytimer() << endl;
#ifdef HPCG_DEBUG
  if (rank==0) {
...
#pragma sst delete
  ...
  if (rank==0) std::cout << "Total time 11: " << mytimer() << endl;
  ...
  if (rank==0) std::cout << "Total time 12: " << mytimer() << endl;
  ////////////////////
  // Report Results //
  ////////////////////
  ...
  if (rank==0) std::cout << "Total time 13: " << mytimer() << endl;
  // Clean up
  ...
  //if (rank==0) std::cout << "Total time 14: " << mytimer() << endl;
  HPCG_Finalize();

  if (rank==0) std::cout << "Total time 15: " << mytimer() << endl;
